...
# DataBase
In this app, the Psql Database URL is ```postgresql://project1:qinjidong@localhost:5432/project-1```
There are There data tables in database project-1, 'users', 'books' and 'reviews'.